...
- **AI趣味互动**：坏情绪输入，四倍快乐输出
  - 🔥 黑暗激励：越丧越燃的鼓励话语（30-50字）
  - 💀 毒鸡汤：一针见血的现实感悟（30-50字）
  - 😂 笑话：幽默搞笑的段子（30-80字，有梗有反转）
  - 💎 哲理名言：假装深刻的金句（30-50字）
...
3. **查看回应**：四张纸条散乱放置在屏幕上，点击翻面查看AI生成的内容
4. **拖拽重新碎纸**：
   - 选择一张你喜欢的纸条
   - 拖动到右下角的垃圾桶🗑️
   - 松手后，用该纸条的内容重新生成四张新纸条
5. **继续探索**：不断拖拽，不断发现新的有趣回应

### 🎮 交互说明

- **卡片翻面**：点击卡片可以翻面查看内容
- **拖拽操作**：按住鼠标拖动纸条到垃圾桶，松手即可重新碎纸
- **散乱布局**：四张纸条随机散落在屏幕四个象限，更有真实感
- **视觉反馈**：拖动时纸条半透明，垃圾桶会高亮并跳动
